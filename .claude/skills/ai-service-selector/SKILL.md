...
description: |
  Decision matrix для выбора сервиса генерации (Seedance 2.0 / Kling / Flow) для каждой сцены
...
**Сервисы:** Seedance 2.0, Kling AI, Google Flow (Veo 3.1 / Veo 2).
...
- **Detail skill:** `.claude/skills/seedance-2-prompting/SKILL.md`
...
- **Worst for:** Фотореалистичные человеческие лица (ниже Seedance 2.0), бюджетные итерации (нет бесплатного режима)
...
- **Seedance 2.0 (2K)** — для сцен с людьми и сложной физикой
...
4. **Seedance 2.0 (2K)** — ТОЛЬКО для hero-сцен с людьми после 3-минутной отметки
...
```
Для каждого клипа сцены (сцена содержит несколько клипов — по 1 на длинное предложение или группу коротких):
...
2P. PREMIUM TIER MODEL SELECTION
   ├─ Human faces/bodies prominent? ──→ Seedance 2.0 (2K) (1080p)
...
2E. ECONOMY TIER MODEL SELECTION
   ├─ Human faces (hero scene)? ────────→ Seedance 2.0 (2K) (exception)
...
3. SPECIAL CASES
   ...
   ├─ Audio sync needed in footage? ────────────────────→ Seedance 2.0 or Flow Veo 3.1
...
|---|---|---|---|---|---|---|
| Hook / opening | < 3 min | Yes | Any | Premium | Seedance 2.0 (2K) | Kling Professional |
...
| Hero scene | >= 3 min | Yes | Any | Exception | Seedance 2.0 (2K) | Kling Professional |
...
| Product shot | Any | No | Slow | Varies | Kling Professional | Seedance 2.0 |
...
|---|---|---|---|
| Seedance 2.0 | Kling Professional | Flow Quality | Stock footage |
| Kling | Flow Quality/Fast | Seedance 2.0 | Stock footage |
| Flow | Kling Standard | Seedance 2.0 | Stock footage |
...
- **Расклад:** Seedance 2.0 / Kling Professional для первых 3 мин (5–8 сцен),
...
- **Стратегия:** Seedance 2.0 (2K) / Kling Professional для ВСЕХ сцен
- **Подписки:** Jimeng 高级会员 (¥499/mo) + Kling Ultra ($180/mo) + Google AI Ultra ($249.99/mo)
...
- `MAX_SEEDANCE_SCENES` — лимит на количество Seedance 2.0 сцен (бюджетный контроль)
