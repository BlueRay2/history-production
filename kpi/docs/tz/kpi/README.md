...
| 07 | [task-07-monitoring-ui.md](task-07-monitoring-ui.md) | Flask app with 6 pages (24h summary, freshness matrix, quota usage, schema drift, video coverage, errors register) | `in-progress` | — | — |
