...
| 05 | [task-05-backfill-bootstrap.md](task-05-backfill-bootstrap.md) | One-shot 60-day backfill script; quota-aware pacing; idempotent | `in-review (r 1)` | ⏳ round 1 dispatched | ⏳ round 1 dispatched |
| 06 | [task-06-monitoring-schema.md](task-06-monitoring-schema.md) | Schema for ingest health: ingestion_runs extension, freshness derived view, quota_usage table, schema_drift detector | `in-review (r 1)` | ⏳ pending dispatch (sequential after task-05) | ⏳ pending dispatch |
