...
| 08 | [task-08-cron-systemd-tests.md](task-08-cron-systemd-tests.md) | Cron + systemd timer for nightly 03:30; vcrpy cassettes; smoke tests; failure→Telegram alert (direct Bot API curl, not MCP) | `in-review (r 1)` | — | — |
