...
| 02 | [task-02-decommission-old-dashboard.md](task-02-decommission-old-dashboard.md) | Backup + drop `dashboard-kpi.sqlite`; disable `claude-kpi-dashboard.service`; remove old Flask routes | `merged` | — | — |
