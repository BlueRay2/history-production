...
| 05 | [task-05-mapping-and-derived-kpis.md](task-05-mapping-and-derived-kpis.md) | `video_project_map` + derived KPI views: cycle-time, scripts-per-week, script-iterations (approx), cost-per-video (fail-closed parser) | `in-review (r 1)` | — | — |
