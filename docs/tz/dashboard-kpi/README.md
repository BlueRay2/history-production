...
| 06 | [task-06-web-shell-and-weekly-tab.md](task-06-web-shell-and-weekly-tab.md) | Flask app skeleton, `/weekly` route, metric cards, retention chart, exceptions panel, calibration banner | `in-review (r 1)` | — | — |
