...
| 04 | [task-04-history-git-parser.md](task-04-history-git-parser.md) | `ingest/history_git.py`, heuristic commit scoring (phase-\d+ / script / final / lock patterns), confidence + evidence columns, golden git fixtures | `in-review (r 1)` | pending | pending |
