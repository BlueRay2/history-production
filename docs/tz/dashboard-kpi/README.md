...
| 07 | [task-07-monthly-tab-and-exceptions.md](task-07-monthly-tab-and-exceptions.md) | `/monthly` route, composite-score top-performers, cost-distribution, unmapped-cities panel | `in-review (r 1)` | — | — |
